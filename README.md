...
Số lượng ô màu được đổ không được vượt quá số ô trống liên tiếp trên cùng của lọ đích. 
Nếu lọ đích hoàn toàn rỗng thì có thể nhận bất kỳ màu nào từ lọ nguồn. 

Kết quả:
Sau khi đổ, các ô vừa lấy khỏi lọ nguồn được gán thành rỗng. 
Sau khi đổ, các ô trống trên cùng của lọ đích được thay bằng màu vừa đổ. 
Một trạng thái được coi là hợp lệ nếu mỗi lọ luôn có dạng: 1 list có từ 0 đến 4 số (có giá trị từ 1 đến 3)
rạng thái đích đạt được khi state == GOAL
